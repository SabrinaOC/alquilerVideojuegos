...
$listaJuegos = JuegoController::findAll();
...
<div class="container my-5">
    ...
    <div class="d-flex flex-wrap bg-light justify-content-center mt-5">
        ...
        <?php
            ...
            echo "<a href='detalleJuego.php?juego=". $value->codJuego
                    ."'><img src='". $value->imagen ."' width='250px' height='400px'";
            if (isset($_SESSION['logueado']) && $_SESSION['logueado'] && $value->alquilado != 'NO') {
                echo "class='JuegoAlquilado'>";
                echo "</a>";
            } else {
                echo "</a>";
            }
                    ...
                    <div class="col-12 d-flex justify-content-center mt-2 mb-5">
                        <form action="" method="post">
                            ...
                            <button type="button" class="btn btn-danger" 
                                    style="width:100%" disabled>Alquilado</button>
