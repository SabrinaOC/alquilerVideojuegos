...
<div class="container my-5" id="tablaJuegos">
    <h3 class="text-center">Lista juegos modificar</h3>
    ...
    <div class="d-flex justify-content-center" >
            ...
            foreach ($todosJuegos as $key => $value){
                ?>
            <tr><form action="formModJuego.php" method="post">
            <?php
            ...
            <td><button type="submit" class="btn btn-danger" name="modificar" value="<?php echo $value->codJuego ?>">Modificar</button></td>
            </form>
            </tr>
               <?php
